...
try {/* Comentário *//* Variável Booleana */$bool_ex = true;/* Variável string */$str_ex = "olá";/* Variável int */$int_ex = 123;/* Variável Float */$float_ex = 134.67;/* Condicional */if($int_ex == 123) {echo($int_ex . PHP_EOL);} else {echo('int não encontrado. PHP_EOL');}/* class */class Mamifero{public function __construct($idade){$this->idade = $idade;}public function vc_anda(){return true;}}/* Criar class */$Cachorro = new Mamifero(20);echo($Cachorro->vc_anda() . PHP_EOL);
    } catch (Exception $e) {
